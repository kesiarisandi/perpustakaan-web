...
<!-- menu tengah -->
	<div id="menu-tengah">
        ...
        <form action="?page=transaksi_proses1" method="post">
   	        ...
   	        <tbody>
            	<tr>
                    ...
                    <td><select name="buku">
                        ...
                        <?php
							$sql = mysqli_query($konek,"SELECT * FROM tbl_buku ORDER by id");
                ...
                <tr>
                    ...
                    <td><select name="peminjam">
                        ...
                        <?php 
							$sql = mysqli_query($konek,"SELECT * FROM tbl_user ORDER by id");
