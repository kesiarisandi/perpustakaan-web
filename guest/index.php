...
<div>    
    <!-- menu Kiri -->
 	<div id="menu-kiri">
    	...
    	<div id="left_menu">
        	...
        	<a href="?page=transaksi1" class="menu">&raquo; Transaksi </a> <br />
            <a href="?page=laporan1" class="menu">&raquo; Laporan </a> <br />
				 ...
				 switch($_GET['page'])
				 	{
						...
						break;
						case "transaksi_input1";
						include "../transaksi_input1.php";
						break;
						case "transaksi_proses1";
						include "../transaksi_proses1.php";
						break;
						case "transaksi_search1";
						include "../transaksi_search1.php";
						break;
						// menu buku
						case "buku";
    ...
    <div class="clear">
  	...
  	<!-- menu Footer -->
    <div id="footer"><center>Tengku Indah Novrianti &copy; 2022</center></div>
